...
function isBasketMetadataItem(item) {
  return item?.category === BASKET_CATEGORY || item?.category === BASKET_ITEM_CATEGORY;
}

module.exports = { buildBasketMetadataItems, isBasketMetadataItem, splitBasketMetadata };
